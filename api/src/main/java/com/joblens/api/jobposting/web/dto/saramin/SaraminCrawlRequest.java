...
@Schema(
    description = "사람인 크롤링 옵션. 생략 시 크롤러 기본값 사용.",
    example = """
    {
...
public class SaraminCrawlRequest {
     ...
     */
    public static SaraminCrawlRequest defaultForHourly() {
        SaraminCrawlRequest r = new SaraminCrawlRequest();
